...
export const DEFAULT_TEMPLATES: TemplateSpec[] = [
  ...
  },
  {
    ...
    tools: [
      ...
      { toolKey: 'commitments', level: 'standard', privileges: ['create', 'execute'] },
      { toolKey: 'invoicing', level: 'standard', privileges: ['review', 'pay', 'release_retainage'] },
  ...
  },
  {
    ...
    tools: [
      ...
      { toolKey: 'commitments', level: 'read_only' },
      { toolKey: 'invoicing', level: 'read_only' },
  ...
  },
  {
    ...
    tools: [
      ...
      { toolKey: 'commitments', level: 'none' },
      { toolKey: 'invoicing', level: 'none' },
      { toolKey: 'drawings', level: 'read_only', privileges: ['pin'] },
      { toolKey: 'specifications', level: 'read_only' },
      { toolKey: 'capture', level: 'standard', privileges: ['review'] },
  ...
  },
  {
    ...
    tools: [
      ...
      { toolKey: 'commitments', level: 'none' },
      { toolKey: 'invoicing', level: 'none' },
      { toolKey: 'drawings', level: 'read_only' },
      { toolKey: 'specifications', level: 'read_only' },
      { toolKey: 'capture', level: 'read_only' },
      { toolKey: 'documents', level: 'read_only' },
      { toolKey: 'project_team', level: 'read_only' },
